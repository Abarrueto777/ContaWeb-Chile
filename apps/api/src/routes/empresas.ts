...
import licenciasRouter from './licencias';
import dj1887Router from './dj1887';
import dj1879Router from './dj1879';
import f22Router from './f22';
import sociosRouter from './socios';
import retirosRouter from './retiros';
import dj1886Router from './dj1886';
import dj1948Router from './dj1948';
import rentaPresuntaRouter from './rentaPresunta';
import propymeRouter from './propyme';
...
router.use('/:empresaId/vacaciones', vacacionesRouter);
router.use('/:empresaId/permisos', permisosRouter);
router.use('/:empresaId/licencias', licenciasRouter);
router.use('/:empresaId/dj1887', dj1887Router);
router.use('/:empresaId/dj1879', dj1879Router);
router.use('/:empresaId/f22', f22Router);
router.use('/:empresaId/socios', sociosRouter);
router.use('/:empresaId/retiros', retirosRouter);
router.use('/:empresaId/dj1886', dj1886Router);
router.use('/:empresaId/dj1948', dj1948Router);
router.use('/:empresaId/renta-presunta', rentaPresuntaRouter);
router.use('/:empresaId/propyme', propymeRouter);
